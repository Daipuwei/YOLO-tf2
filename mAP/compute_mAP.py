...
parser.add_argument('--results_files_path', type=str)
...
#results_files_path = "results/Cityscapes/yolov4/608x1216/Adadelta-lr=1.0/ciou-loss/batchsize=4/20210802212119/trained_yolo_model_stage_2.h5"
#results_files_path = os.path.abspath("./results/BBDD100k-Night/yolov4/416x832/Adadelta-lr=1.0/use-mosaic=1/batchsize=16/20210831091255/trained_yolo_model_stage_2.h5")
results_files_path = os.path.abspath(args.results_files_path)
